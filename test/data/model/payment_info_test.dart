...
void main() {
  group('Next date of payment', () {
    test('Next date should return today date', () {
      ...
      final paymentInfo = PaymentInfo(monthlyPayment: 7, currency: 'USD', dayOfTheMonth: 23);
    ...
    test('Next date should return date with same month', () {
      ...
      final paymentInfo = PaymentInfo(monthlyPayment: 7, currency: 'USD', dayOfTheMonth: 9);
    ...
    test('Next date should return date in next month', () {
      final today = DateTime(2022, 5, 7);
      final paymentInfo = PaymentInfo(monthlyPayment: 7, currency: 'USD', dayOfTheMonth: 6);
    ...
    test('Next date should return 28-02-2022', () {
      ...
      final paymentInfo = PaymentInfo(monthlyPayment: 7, currency: 'USD', dayOfTheMonth: 31);
  ...
  group('Days until next payment', () {
    ...
    test('Should return 29', () {
      ...
      final paymentInfo = PaymentInfo(monthlyPayment: 7, currency: 'USD', dayOfTheMonth: 16);
